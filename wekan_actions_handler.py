...
__Action_2_Delivery_Temp = {
    ...
    "act-addChecklist": "{user} 添加了待办清单\n看板：{board}\n列表：{list}\n任务：{card}",
    "act-removeChecklist": "{user} 移除了待办清单\n看板：{board}\n列表：{list}\n任务：{card}",
    "act-addChecklistItem": "{user} 添加了待办清单项\n看板：{board}\n列表：{list}\n任务：{card}",
    "act-checkedItem": "{user} 完成了待办清单项\n看板：{board}\n列表：{list}\n任务：{card}",
    "act-uncheckedItem": "{user} 修改/复原了待办清单项\n看板：{board}\n列表：{list}\n任务：{card}",
    "act-removedChecklistItem": "{user} 移除了待办清单项\n看板：{board}\n列表：{list}\n任务：{card}",
    "act-completeChecklist": "{user} 完成了清单\n看板：{board}\n列表：{list}\n任务：{card}",
    "act-uncompleteChecklist": "{user} 复原了清单\n看板：{board}\n列表：{list}\n任务：{card}",
